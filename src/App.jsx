  ...
  return (
    <div className=' h-screen bg-gray-900 overflow-auto font-rubik '>
      <form onSubmit={submithandler} className= 'h-52 flex  flex-col sm:flex-row justify-center items-center flex-wrap' >
        ...
        <input type="text" name='link' id='link' value={data.link} onChange={handleInputs} placeholder='Enter youtube share link' className='m-2 block h-8 w-auto rounded-md border-2 p-2 shadow-xl outline-none hover:border-blue-300 focus:border-blue-300 md:w-1/5 ' />
